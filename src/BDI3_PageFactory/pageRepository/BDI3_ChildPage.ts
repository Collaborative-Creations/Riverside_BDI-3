...
export class BDI3_ChildPage {
    ...
    constructor(page: Page, context: BrowserContext) {
        ...
        this.SAVED_SUCCESSFUL_POPUP = page.locator("//div[@class='textGray' and text()='Save successful!']");
        ...
        this.DATE_OF_BIRTH_TEXT = page.locator("(//input[@class='text-input with-icon'])[1]");
    ...
    async createNewExaminee() {
        ...
        await this.savepopup("Save successful!");
    ...
    async savepopup(_successMessage: string) {
        await this.SAVED_SUCCESSFUL_POPUP.waitFor({ state: 'visible', timeout: 60000 });
        await this.OK_BUTTON.click();
    }
